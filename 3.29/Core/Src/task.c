...
#define init_value sel = firF = ModeF = temp.x = temp.y = joy_result = 0

const uint8_t lastDay[12] = { 31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31 };
const char ptTime[6][10] = { "Year", "Month", "Day", "Hour", "Min", "Sec" };
...
uint8_t firF = 1, buzM = 0, ModeF = 0, sel = 0, findC, ptionC, ledM, start_check, use_num = 1;;
uint16_t ledC=0, buzC, adcV[2], cnt;
char* input_name = NULL;
char* find_name = NULL;
TIME time = { 23, 3, 29, 0, 0, 0 };
